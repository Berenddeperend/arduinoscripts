...
void loop(){
  ...
  servoX.write(map(analogRead(A0), 0, 1023, 2400, 544)); 
  servoY.write(map(analogRead(A2), 0, 1023, 544, 2400)); 


  Serial.println(map(analogRead(A0), 0, 1023, 544,2400));
  Serial.println(map(analogRead(A2), 0, 1023, 544,2400));
  Serial.println("-----");
